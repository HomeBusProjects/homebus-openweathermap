...
require_relative 'lib/homebus-openweathermap/version'

Gem::Specification.new do |spec|
  spec.name = 'homebus-openweathermap'
  spec.version = HomebusOpenweathermap::VERSION
  ...
  spec.homepage = 'https://github.com/HomeBusProjects/homebus-openweathermap'
  spec.license = 'MIT'
  spec.required_ruby_version = '>= 2.7.4'

  spec.metadata['homepage_uri'] = spec.homepage
  spec.metadata['source_code_uri'] = 'https://github.com/HomeBusProjects/homebus-openweathermap'
